...
export default class MoviePopupView {
  ...
  showPopup() {
    if (!MoviePopupView._isShow) {
      document.body.append(this._element);
      MoviePopupView._isShow = true;
    }
  }
  ...
  _initEventListeners() {
    this._element.querySelector('.film-details__close-btn').addEventListener('click', this.closePopup);
  }

  closePopup = () => {
    this.removeElement();
    MoviePopupView._isShow = false;
  };
